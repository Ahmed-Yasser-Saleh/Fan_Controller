...
# 1 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio.h" 1
# 12 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio.h"
# 1 "ECU_layer/Motor/../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 11 "ECU_layer/Motor/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 11 "ECU_layer/Motor/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 28 "ECU_layer/Motor/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 12 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio.h" 2


# 1 "ECU_layer/Motor/../../MCAL_layer/GPIO/../device_config.h" 1
# 17 "ECU_layer/Motor/../../MCAL_layer/GPIO/../device_config.h"
...
# 14 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio.h" 2

# 1 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio_config.h" 1
# 15 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio.h" 2
# 32 "ECU_layer/Motor/../../MCAL_layer/GPIO/gpio.h"
typedef enum {
    LOW,
    HIGH
}Logic_t;
...
# 9 "ECU_layer/Motor/ecu_motor.c" 2
...
Std_ReturnType motor_initialize(const motor_confg_t *motor){
    ...
    if(((void*)0) == motor)
        ...
        gpio_pin_intialize(&(motor->motor_confg[0]));
        gpio_pin_intialize(&(motor->motor_confg[1]));
    }
    return ret;
}
...
Std_ReturnType motor_move_right(const motor_confg_t *motor){
    ...
    if(((void*)0) == motor)
        ...
        gpio_pin_write_logic(&(motor->motor_confg[0]),LOW);
        gpio_pin_write_logic(&(motor->motor_confg[1]),HIGH);
    }
    return ret;
}
Std_ReturnType motor_move_left(const motor_confg_t *motor){
    ...
    if(((void*)0) == motor)
        ...
        gpio_pin_write_logic(&(motor->motor_confg[0]),HIGH);
        gpio_pin_write_logic(&(motor->motor_confg[1]),LOW);
    }
    return ret;
}
Std_ReturnType motor_turn_off(const motor_confg_t *motor){
