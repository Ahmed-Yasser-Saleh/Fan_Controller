...
# 28 "MCAL_layer/ADC/../mcal_std_types.h"
...
# 17 "MCAL_layer/ADC/../device_config.h"
...
# 12 "MCAL_layer/ADC/../Interrupt/interrupt_cfg.h"
# 1 "MCAL_layer/ADC/../Interrupt/interrupt_generate_cfg.h" 1
# 12 "MCAL_layer/ADC/../Interrupt/interrupt_cfg.h" 2
# 49 "MCAL_layer/ADC/../Interrupt/interrupt_cfg.h"
typedef enum{
    LOW_PRIORITY,
    HIGH_PRIORITY
...
Std_ReturnType ADC_GetConversion_Blocking(const adc_confg_t *adc_confg, adc_channel_select_t channel,
    ...
    if((((void*)0) == adc_confg) || (((void*)0) == conversion_result)){
        ret = (Std_ReturnType)0x00;
    }
    else{
