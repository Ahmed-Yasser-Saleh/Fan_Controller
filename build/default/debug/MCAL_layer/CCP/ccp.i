...
# 28 "MCAL_layer/CCP/../mcal_std_types.h"
...
# 12 "MCAL_layer/CCP/ccp.h" 2


# 1 "MCAL_layer/CCP/../device_config.h" 1
# 17 "MCAL_layer/CCP/../device_config.h"
...
# 1 "MCAL_layer/CCP/../Interrupt/interrupt_cfg.h" 1
# 12 "MCAL_layer/CCP/../Interrupt/interrupt_cfg.h"
# 1 "MCAL_layer/CCP/../Interrupt/interrupt_generate_cfg.h" 1
# 12 "MCAL_layer/CCP/../Interrupt/interrupt_cfg.h" 2
# 49 "MCAL_layer/CCP/../Interrupt/interrupt_cfg.h"
typedef enum{
    LOW_PRIORITY,
    HIGH_PRIORITY
...
# 1 "MCAL_layer/CCP/../Interrupt/interrupt_internal.h" 1
# 16 "MCAL_layer/CCP/ccp.h" 2

# 1 "MCAL_layer/CCP/ccp_cfg.h" 1
# 17 "MCAL_layer/CCP/ccp.h" 2

# 1 "MCAL_layer/CCP/../GPIO/gpio.h" 1
# 15 "MCAL_layer/CCP/../GPIO/gpio.h"
# 1 "MCAL_layer/CCP/../GPIO/gpio_config.h" 1
# 15 "MCAL_layer/CCP/../GPIO/gpio.h" 2
# 32 "MCAL_layer/CCP/../GPIO/gpio.h"
typedef enum {
    LOW,
    HIGH
}Logic_t;
...
Std_ReturnType CCP_Init( ccp_confg_t *ccp_obj){
    ...
    {
        if(ccp_obj->ccp_mode == 0x00)
            CCP1CONbits.CCP1M = ((uint8)0x00);

        else if(ccp_obj->ccp_mode == 0x01)
        ...
        if(ccp_obj->ccp_mode == 0x00)
        {
# 80 "MCAL_layer/CCP/ccp.c"
            if (ccp_obj->ccp_mode_module == 0x02)
            {
...
static Std_ReturnType set_pwm_period(ccp_confg_t *ccp_obj){
    ...
    {
        PR2 = (uint8)(((float)4000000UL / ((float)ccp_obj->pwm_freq * 4.0 * (float)ccp_obj->timer2_prescaler *
